...
if "highway" in args.scenario:
    if (len(crash_info) == 0) or (len(file_info) == 0):
        print("Please run the processing data first before runing this")
        exit()
