...
plt.figure(2)
l1 = plt.legend()
p1, = plt.plot([0], [0], linestyle="-", color="black", label="Unique Crashes")
p2, = plt.plot([0], [0], linestyle="--", color="black", label="Total Crashes")
plt.legend([p1, p2], ["Unique Crashes", "Total Crashes"], loc="lower right")
plt.xlabel("Time (Days)")
plt.ylabel("Crashes")
plt.ticklabel_format(style='plain')
plt.grid(alpha=0.5)
