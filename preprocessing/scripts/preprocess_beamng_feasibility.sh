...
if [ $# -eq 1 ]
  then
    python3 preprocess_feasibility.py --scenario beamng --cores 1 --distribution linear --data_path $1
    python3 preprocess_feasibility.py --scenario beamng --cores 1 --distribution center_mid --data_path $1
