...
if [ $# -eq 0 ]
  then
    python3 preprocess_feasibility.py --scenario highway --cores 1 --distribution center_full
    python3 preprocess_feasibility.py --scenario highway --cores 1 --distribution center_close
fi

if [ $# -eq 1 ]
  then
    python3 preprocess_feasibility.py --scenario highway --cores 1 --distribution center_full --data_path $1
